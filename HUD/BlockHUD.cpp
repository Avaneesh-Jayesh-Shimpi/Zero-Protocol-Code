...
void ABlockHUD::BeginPlay()
{
	Super::BeginPlay();
}

void ABlockHUD::AddCharacterOverlay()
{
...
void ABlockHUD::AddAnnouncement()
{
	APlayerController* PlayerController = GetOwningPlayerController();
...
void ABlockHUD::AddElimAnnouncement(FString Attacker, FString Victim)
{
...
void ABlockHUD::ElimAnnouncementTimerFinished(UElimAnnouncement* MsgToRemove)
{
	if (MsgToRemove)
	{
...
void ABlockHUD::DrawCrosshairs(UTexture2D* Texture, FVector2D ViewportCenter, FVector2D Spread,  FLinearColor CrosshairColor)
{
