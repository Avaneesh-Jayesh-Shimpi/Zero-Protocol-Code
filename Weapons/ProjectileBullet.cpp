...
{
	ABlockCharacter* OwnerCharacter = Cast<ABlockCharacter>(GetOwner());
	if (OwnerCharacter)
	{
		ABlockPlayerController* OwnerController = Cast<ABlockPlayerController>(OwnerCharacter->Controller);
		if (OwnerController)
		{
			...
			ABlockCharacter* HitCharacter = Cast<ABlockCharacter>(OtherActor);
