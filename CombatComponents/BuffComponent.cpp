...
void UBuffComponent::ReplenishShield(float ReplenishAmount, float ReplenishTime)
{
	bReplenishingShield = true;
	ShieldReplenishRate = ReplenishAmount / ReplenishTime;
	AmountToReplenishShield += ReplenishAmount;
}
